...
uv run python -m src.phases.phase1_author forge/20260309180240/codex_20260309180240.json
uv run python -m src.phases.phase1_author forge/20260309180240/codex_20260309180240.json --steps 6  # specific steps

# Phase 2: Prompt generation (requires Phase 1)
uv run python -m src.phases.phase2_prompts forge/20260309180240/codex_20260309180240.json
uv run python -m src.phases.phase2_prompts forge/20260309180240/codex_20260309180240.json --steps 1 2      # specific steps

# Phase 3: Media generation via ComfyUI (requires Phase 2)
uv run python -m src.phases.phase3_generation forge/20260309180240/codex_20260309180240.json

uv run python -m src.phases.phase3_generation forge/20260309180240/codex_20260309180240.json --steps 0 1 2
